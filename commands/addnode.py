...
class CmdAddNode(ClusterCompleter):
    ...
    def addopts(self, parser):
        ...
        parser.add_option(
            "-f", "--force_demand", dest="force_demand", action="store_true",
            default=False, help="do use on-demand instances")
    ...
    def execute(self, args):
        ...
        self.cm.add_nodes(tag, num_nodes, aliases=aliases,
                          ...
                          no_create=self.opts.no_create, force_demand=self.opts.force_demand)
